...
const TopNav = () => {
  ...
  return (
    <div className='w-[55%] mx-auto relative  h-[10vh] flex justify-start  items-center'>
        ...
        <div className='absolute w-[50%] max-h-[50vh] bg-zinc-200 top-[90%] left-[5%] no-scrollbar overflow-x-auto'>
        {searchResult.map((i,ind)=>(
            <Link key={ind} className='inline-block font-semibold hover:text-black hover:bg-zinc-300 duration-300 p-2 rounded flex justify-start border-b-2 border-zinc-200 text-zinc-600 items-center'>
